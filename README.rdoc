Patches included (see http://www.redmine.org)
...
* #1678 Include Estimated Time in issue filters
* #1680 Make version description multiline and textilizable
* #1676 Only show incomplete target versions
* Issue edit screen: targer version made required field
* massive Trac migration improvements, see commit 2dc4fc03dc70deb29a2edb91ec55d64e540b009e for some details

If you applied previously some of these patches that contain database migrations (in old, not timestamped style) you need to remove them with SQL like 

    delete from schema_migrations where version in ('995', '996')

and add their new aliases:

    INSERT INTO schema_migrations (version) VALUES('20080902122005');
    INSERT INTO schema_migrations (version) VALUES('20080902122006');
